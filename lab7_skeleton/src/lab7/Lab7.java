...
public class Lab7 {
    ...
    private void runAnalysis(){
        ...
        System.out.println("=======================================");
        helper.getMaxCommentCountPost();
        System.out.println("=======================================");
        helper.getMaxLikesComment();
        System.out.println("=======================================");
        helper.getUnActivityUserDesc5();
        System.out.println("=======================================");
        helper.getMinCountOfCommentDesc5();
        System.out.println("=======================================");
        helper.getMinCountOfCommentAndPostAndLikes5();
        System.out.println("=======================================");
        helper.getMaxCountOfCommentAndPostAndLikes5();
    }
}
